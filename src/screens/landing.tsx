    ...
    return (
        <>
            ...
            <div className="info">
                ...
                <iframe className="player" src="https://open.spotify.com/embed/track/3AwM5kkgyHfvMO3lRYIJQZ?utm_source=generator" width="100%" height="352" frameBorder="0" allow="autoplay; clipboard-write; encrypted-media; fullscreen; picture-in-picture" loading="lazy"></iframe>
                <div className="container1">
                    ...
                    <img className="img" src="https://i.pinimg.com/564x/2b/ab/56/2bab56d60f1c100be512f11c5d57574b.jpg" alt="Imagen de relajación" />
                </div>
            ...
            <div className="info2">
                ...
                {/* Botón redirige a la página de actividades */}
                <Link to="https://www.icesi.edu.co/bienestar-universitario/">
                ...
                {/* Botón redirige a la página de playlist */}
